...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "Suhail", email: "Moidin", age: 21)
...
var me = User(userName: "Suhail", email: "suhail.moidin@gmail.com", age: 22)
User.currentUser = me

var secondUser = User(userName: "Haili", email: "haili@gmail.com", age: 10)
